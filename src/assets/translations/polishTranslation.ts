...
const polishTranslation = {
  ...
  pages: {
    ...
    contact: {
      contactForm: {
        header: "Umów się na spotkanie",
        text1:
          "Na spotkaniu dobierzemy dopasowaną do Ciebie opcję ubezpieczenia lub znajdziemy najlepszą ofertę kredytu. Gwarantujemy fachowe doradztwo oraz wsparcie na każdym etapie.",
        form1Placeholder: "Imię",
        form2Placeholder: "Adres email",
        form3Options: {
